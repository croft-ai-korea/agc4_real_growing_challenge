...
(
    ...
    accumulate_temperature                           double precision,
    irrigation_ml                                    double precision,
    shot_number                                      double precision,   
    par1_5min                                        double precision,     
    par1                                             double precision,
    par1_day                                         double precision,    
    par1_night                                       double precision,         
